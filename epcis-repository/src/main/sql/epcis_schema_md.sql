...
-- Extension tables must fallow the pattern XX_extensions where XX is the vocabulary name without the "voc_" substring
...
-- Vocabularies --
CREATE TABLE `Vocabularies` (		-- maps uri to table name
`id` bigint PRIMARY KEY auto_increment,
`uri` varchar(1023) NOT NULL,		-- uri of vocabulary Type
`table_name` varchar(128) NOT NULL CHECK (`table_name` IN ('voc_BizLoc','voc_BizStep','voc_BizTransType','voc_BizTrans','voc_Disposition','voc_ReadPoint','voc_EPCClass'))
);
