...
public class QueryClientGuiExampleQueries {
     ...
     */
    public Vector<Query> examples = new Vector<Query>();
    ...
    public QueryClientGuiExampleQueries() {
        ...
        ex.getQueryParametersVector().add(new QueryParam("EQ_action", "ADD"));
        ex.getQueryParametersVector().add(new QueryParam("MATCH_parentID",
        ...
        ex.getQueryParametersVector()
                .add(new QueryParam("GE_eventTime", "2006-01-01T05:20:31"));
        ...
        /*
        ex.getQueryParametersVector()
                .add(new QueryParam("GE_eventTime", "2006-02-14T00:00:00"));
        ex.getQueryParametersVector()
                .add(new QueryParam("LT_eventTime", "2006-02-15T00:00:00"));
        */
        ex.getQueryParametersVector().add(new QueryParam("EQ_readPoint",
                "urn:epcglobal:fmcg:ssl:0037000.00729.210,414"));
        examples.add(ex);

        /*
        Example disabled - not supported by GUI
        see QueryInterfaceClientSwingGui.generateParamHashMap()
         
        ex = new QueryInterfaceQueryExample();
        ex.setDescription("Get status information about shipment");
        ex.setReturnObjectEvents(true);
        ex.setReturnTransactionEvents(true);
		...
		*/
        ...
        ex.setReturnObjectEvents(true);
        ex.getQueryParametersVector()
                .add(new QueryParam("EQ_action", "OBSERVE"));
        ex.getQueryParametersVector().add(new QueryParam("EQ_bizStep",
        ...
        /*
        ex = new QueryInterfaceQueryExample();
        ex.setDescription("Find all events caused by two EPCs (only "
                + "ObjectEvent and AggragationEvent may be queried this way)");
        ex.setReturnObjectEvents(true);
        ex.setReturnAggregationEvents(true);
        ex.getQueryParametersVector().add(new QueryParam("MATCH_epc",
                "urn:epc:id:sgtin:0057000.123430.2028 "
        ...
        */
        ...
        ex.getQueryParametersVector()
                .add(new QueryParam("EQ_action", "OBSERVE"));
        ex.getQueryParametersVector()
                .add(new QueryParam("GE_eventTime", "2006-01-01T00:00:00"));
        ex.getQueryParametersVector()
                .add(new QueryParam("LT_eventTime", "2007-01-01T00:00:00"));
        ex.getQueryParametersVector().add(new QueryParam("EQ_disposition",
