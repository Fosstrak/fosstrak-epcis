...
/**
 * Parameter for Fieldname equal attributes (used for extensions)
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 *
 */
public class FieldnameEQATTR extends AbstractArrayOfStringParameter {
     ...
     */
    public FieldnameEQATTR(String value) throws ParseException, QueryParameterExceptionResponse {
        super(FIELDNAME_REST, EQATTR_fieldname_attrname, value);
    }
}
