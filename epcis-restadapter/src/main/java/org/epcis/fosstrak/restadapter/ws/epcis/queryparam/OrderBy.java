...
/**
 * Parameter for Order By.
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 *
 */
public class OrderBy extends AbstractStringParameter {

    public static final String BY_EVENT_TIME  = "eventTime";
    public static final String BY_RECORD_TIME = "recordTime";
     ...
     */
    public OrderBy(String value) throws ParseException, QueryParameterExceptionResponse {
        super(ORDER_BY_REST, orderBy, value);
    }
}
