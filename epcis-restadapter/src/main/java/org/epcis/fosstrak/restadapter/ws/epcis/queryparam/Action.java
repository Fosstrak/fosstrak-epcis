 ...
 *
 */
public class Action extends AbstractArrayOfStringParameter {
     ...
     */
    public Action(String value) throws ParseException, QueryParameterExceptionResponse {
        super(ACTION_REST, EQ_action, value);
    }
}
