...
public class GSRN implements EPC {

    public static final String NAME = "Global Service Relation Number";
    public static final String ID   = GSRN_PREFIX;
    private String             epc;
    ...
    public List<Entry> getComponents() {
        ...
        entry2.setName(SERVICE_REFERENCE);
        entry2.setValue(serviceReference);
        entry2.setValueRef(ID + companyPrefix + "." + serviceReference);
