 ...
 *
 */
public class Epc extends AbstractArrayOfStringParameter {
     ...
     */
    public Epc(String value) throws ParseException, QueryParameterExceptionResponse {
        super(EPC_REST, MATCH_epc, value);
    }
}
