...
/**
 * Parameter for Event Count Limit
 *
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class EventCountLimit extends AbstractIntegerParameter {
     ...
     */
    public EventCountLimit(String value) throws ParseException, QueryParameterExceptionResponse {
        super(EVENT_COUNT_LIMIT_REST, eventCountLimit, value);
    }
}
