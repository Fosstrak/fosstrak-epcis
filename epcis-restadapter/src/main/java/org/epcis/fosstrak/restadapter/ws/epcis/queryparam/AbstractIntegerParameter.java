...
/**
 * Abstract Parameter for Integer
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 */
public class AbstractIntegerParameter extends AbstractParameter {
     ...
     */
    public AbstractIntegerParameter(String name, String paramName, String value) throws ParseException, QueryParameterExceptionResponse {
