...
/**
 * Parameter for EPC Class
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 */
public class EpcClass extends AbstractArrayOfStringParameter {
     ...
     */
    public EpcClass(String value) throws ParseException, QueryParameterExceptionResponse {
        super(EPC_CLASS_REST, MATCH_epcClass, value);
    }
}
