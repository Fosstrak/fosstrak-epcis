...
/**
 * Parameter for Fieldname exists (used for extensions)
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class FieldnameExists extends AbstractVoidParameter {
     ...
     */
    public FieldnameExists(String value) throws ParseException, QueryParameterExceptionResponse {
        super(FIELDNAME_REST, EXISTS_fieldname, value);
    }
}
