...
/**
 * Parameter for Record Time greater than
 *
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class RecordTimeGE extends AbstractTimeParameter {
     ...
     */
    public RecordTimeGE(String value) throws ParseException, QueryParameterExceptionResponse {
        super(RECORD_TIME_REST_GE, GE_recordTime, value);
    }
}
