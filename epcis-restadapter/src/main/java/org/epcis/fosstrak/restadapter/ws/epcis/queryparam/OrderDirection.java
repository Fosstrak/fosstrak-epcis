 ...
 *
 */
public class OrderDirection extends AbstractStringParameter {
     ...
     */
    public OrderDirection(String value) throws ParseException, QueryParameterExceptionResponse {
        super(ORDER_DIRECTION_REST, orderDirection, value);
    }
}
