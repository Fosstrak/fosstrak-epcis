...
/**
 * Parameter for Read Points with Descendants
 *
 *
 ...
 *
 */
public class ReadPointWD extends AbstractArrayOfStringParameter {
     ...
     */
    public ReadPointWD(String value) throws ParseException, QueryParameterExceptionResponse {
        super(READ_POINT_REST, EQ_readPoint, value);
    }
}
