...
/**
 * Parameter for Event Type
 *
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class EventType extends AbstractArrayOfStringParameter {
     ...
     */
    public EventType(String value) throws ParseException, QueryParameterExceptionResponse {
        super(EVENT_TYPE_REST, eventType, value);
    }
}
