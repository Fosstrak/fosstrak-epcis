...
/**
 * Parameter for Max Event Count
 *
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class MaxEventCount extends AbstractIntegerParameter {
     ...
     */
    public MaxEventCount(String value) throws ParseException, QueryParameterExceptionResponse {
        super(MAX_EVENT_COUNT_REST, maxEventCount, value);
    }
}
