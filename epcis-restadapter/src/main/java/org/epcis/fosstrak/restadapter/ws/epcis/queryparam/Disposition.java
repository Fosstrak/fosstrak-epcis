...
/**
 * Parameter for Disposition
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class Disposition extends AbstractArrayOfStringParameter {
     ...
     */
    public Disposition(String value) throws ParseException, QueryParameterExceptionResponse {
        super(DISPOSITION_REST, EQ_disposition, value);
    }
}
