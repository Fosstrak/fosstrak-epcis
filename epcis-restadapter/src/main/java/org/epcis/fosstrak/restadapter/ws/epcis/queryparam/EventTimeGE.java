...
/**
 * Parameter for Event Time greater than
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class EventTimeGE extends AbstractTimeParameter {
     ...
     */
    public EventTimeGE(String value) throws ParseException, QueryParameterExceptionResponse {
        super(EVENT_TIME_REST_GE, GE_eventTime, value);
    }
}
