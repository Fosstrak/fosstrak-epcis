...
/**
 * Parameter for Location with Descendant
 *
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class LocationWD extends AbstractArrayOfStringParameter {
     ...
     */
    public LocationWD(String value) throws ParseException, QueryParameterExceptionResponse {
        super(BUSINESS_LOCATION_REST, EQ_bizLocation, value);
    }
}
