...
/**
 * Parameter for Fieldname has attributes (used for extensions)
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 *
 */
public class FieldnameHASATTR extends AbstractArrayOfStringParameter {
     ...
     */
    public FieldnameHASATTR(String value) throws ParseException, QueryParameterExceptionResponse {
        super(FIELDNAME_REST, HASATTR_fieldname, value);
    }
}
