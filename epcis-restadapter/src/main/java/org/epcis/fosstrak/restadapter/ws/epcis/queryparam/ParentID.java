 ...
 *
 */
public class ParentID extends AbstractArrayOfStringParameter {
     ...
     */
    public ParentID(String value) throws ParseException, QueryParameterExceptionResponse {
        super(PARENT_ID_REST, MATCH_parentID, value);
    }
}
