...
/**
 * Parameter for Record Time less than
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 *
 */
public class RecordTimeLT extends AbstractTimeParameter {
     ...
     */
    public RecordTimeLT(String value) throws ParseException, QueryParameterExceptionResponse {
        super(RECORD_TIME_REST_LT, LT_recordTime, value);
    }
}
