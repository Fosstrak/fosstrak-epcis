...
/**
 * Parameter for Business Step
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class BizStep extends AbstractArrayOfStringParameter {
     ...
     */
    public BizStep(String value) throws ParseException, QueryParameterExceptionResponse {
        super(BUSINESS_STEP_REST, EQ_bizStep, value);
    }
}
