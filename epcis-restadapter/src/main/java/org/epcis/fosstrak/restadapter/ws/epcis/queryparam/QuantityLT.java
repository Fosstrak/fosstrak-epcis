...
/**
 * Parameter for Quantity less than
 *
 ...
 *
 */
public class QuantityLT extends AbstractIntegerParameter {
     ...
     */
    public QuantityLT(String value) throws ParseException, QueryParameterExceptionResponse {
        super(QUANTITY_REST_LT, LT_quantity, value);
    }
}
