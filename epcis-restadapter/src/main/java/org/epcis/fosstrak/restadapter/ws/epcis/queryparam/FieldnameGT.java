...
/**
 * Parameter for Fieldname greater than (used for extensions)
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 *
 */
public class FieldnameGT extends AbstractRightClassChooserParameter {
     ...
     */
    public FieldnameGT(String value) throws ParseException, QueryParameterExceptionResponse {
        super(FIELDNAME_REST, GT_fieldname, value);
    }
}
