...
/**
 * Parameter for Event Time less than
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 *
 */
public class EventTimeLT extends AbstractTimeParameter {
     ...
     */
    public EventTimeLT(String value) throws ParseException, QueryParameterExceptionResponse {
        super(EVENT_TIME_REST_LT, LT_eventTime, value);
    }
}
