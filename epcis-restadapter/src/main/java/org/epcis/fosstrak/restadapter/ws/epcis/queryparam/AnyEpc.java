...
/**
 * Parameter for Any EPC
 * @author Mathias Mueller
 * mathias.mueller(at)unifr.ch
 */
public class AnyEpc extends AbstractArrayOfStringParameter {
     ...
     */
    public AnyEpc(String value) throws ParseException, QueryParameterExceptionResponse {
        super(ANY_EPC_REST, MATCH_anyEPC, value);
    }
}
