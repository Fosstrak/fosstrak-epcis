 ...
 *
 */
public class Quantity extends AbstractIntegerParameter {
     ...
     */
    public Quantity(String value) throws ParseException, QueryParameterExceptionResponse {
        super(QUANTITY_REST, EQ_quantity, value);
    }
}
