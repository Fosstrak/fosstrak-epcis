...
public class StandardBusinessDocumentHeader  implements java.io.Serializable {
    ...
    private org.accada.epcis.soapapi.Partner[] sender;

    private org.accada.epcis.soapapi.Partner[] receiver;

    private org.accada.epcis.soapapi.DocumentIdentification documentIdentification;

    private org.accada.epcis.soapapi.Manifest manifest;

    private org.accada.epcis.soapapi.Scope[] businessScope;
    ...
    public StandardBusinessDocumentHeader(
           ...
           org.accada.epcis.soapapi.Partner[] sender,
           org.accada.epcis.soapapi.Partner[] receiver,
           org.accada.epcis.soapapi.DocumentIdentification documentIdentification,
           org.accada.epcis.soapapi.Manifest manifest,
           org.accada.epcis.soapapi.Scope[] businessScope) {
     ...
     * @return sender
     */
    public org.accada.epcis.soapapi.Partner[] getSender() {
        return sender;
    }
     ...
     * @param sender
     */
    public void setSender(org.accada.epcis.soapapi.Partner[] sender) {
        this.sender = sender;
    }

    public org.accada.epcis.soapapi.Partner getSender(int i) {
        return this.sender[i];
    }

    public void setSender(int i, org.accada.epcis.soapapi.Partner _value) {
     ...
     * @return receiver
     */
    public org.accada.epcis.soapapi.Partner[] getReceiver() {
        return receiver;
    }
     ...
     * @param receiver
     */
    public void setReceiver(org.accada.epcis.soapapi.Partner[] receiver) {
        this.receiver = receiver;
    }

    public org.accada.epcis.soapapi.Partner getReceiver(int i) {
        return this.receiver[i];
    }

    public void setReceiver(int i, org.accada.epcis.soapapi.Partner _value) {
     ...
     */
    public org.accada.epcis.soapapi.DocumentIdentification getDocumentIdentification() {
        return documentIdentification;
    }
     ...
     */
    public void setDocumentIdentification(org.accada.epcis.soapapi.DocumentIdentification documentIdentification) {
        this.documentIdentification = documentIdentification;
    }
     ...
     * @return manifest
     */
    public org.accada.epcis.soapapi.Manifest getManifest() {
        return manifest;
    }
     ...
     * @param manifest
     */
    public void setManifest(org.accada.epcis.soapapi.Manifest manifest) {
        this.manifest = manifest;
    }
     ...
     */
    public org.accada.epcis.soapapi.Scope[] getBusinessScope() {
        return businessScope;
    }
     ...
     * @param businessScope
     */
    public void setBusinessScope(org.accada.epcis.soapapi.Scope[] businessScope) {
        this.businessScope = businessScope;
    }
