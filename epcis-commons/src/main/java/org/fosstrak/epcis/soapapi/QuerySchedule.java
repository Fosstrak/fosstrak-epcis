...
public class QuerySchedule  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private org.accada.epcis.soapapi.QueryScheduleExtensionType extension;
    ...
    public QuerySchedule(
           ...
           org.accada.epcis.soapapi.QueryScheduleExtensionType extension,
     ...
     * @return extension
     */
    public org.accada.epcis.soapapi.QueryScheduleExtensionType getExtension() {
        return extension;
    }
     ...
     * @param extension
     */
    public void setExtension(org.accada.epcis.soapapi.QueryScheduleExtensionType extension) {
        this.extension = extension;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis-query:xsd:1", "QuerySchedule"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis-query:xsd:1", "QueryScheduleExtensionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
