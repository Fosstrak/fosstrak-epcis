...
public class QueryParam  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this QueryParam.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this QueryParam.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis-query:xsd:1", "QueryParam"));
