...
public class Subscribe  implements java.io.Serializable {
    ...
    private org.accada.epcis.soapapi.QueryParam[] params;

    private org.apache.axis.types.URI dest;

    private org.accada.epcis.soapapi.SubscriptionControls controls;
    ...
    public Subscribe(
           ...
           org.accada.epcis.soapapi.QueryParam[] params,
           org.apache.axis.types.URI dest,
           org.accada.epcis.soapapi.SubscriptionControls controls,
     ...
     * @return params
     */
    public org.accada.epcis.soapapi.QueryParam[] getParams() {
        return params;
    }
     ...
     * @param params
     */
    public void setParams(org.accada.epcis.soapapi.QueryParam[] params) {
        this.params = params;
    }
     ...
     * @return controls
     */
    public org.accada.epcis.soapapi.SubscriptionControls getControls() {
        return controls;
    }
     ...
     * @param controls
     */
    public void setControls(org.accada.epcis.soapapi.SubscriptionControls controls) {
        this.controls = controls;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis-query:xsd:1", "Subscribe"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis-query:xsd:1", "QueryParam"));
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis-query:xsd:1", "SubscriptionControls"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
