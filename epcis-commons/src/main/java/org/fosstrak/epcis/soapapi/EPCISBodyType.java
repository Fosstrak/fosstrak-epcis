...
public class EPCISBodyType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private org.accada.epcis.soapapi.EPCISBodyExtensionType extension;
    ...
    public EPCISBodyType(
           ...
           org.accada.epcis.soapapi.EPCISBodyExtensionType extension,
     ...
     * @return extension
     */
    public org.accada.epcis.soapapi.EPCISBodyExtensionType getExtension() {
        return extension;
    }
     ...
     * @param extension
     */
    public void setExtension(org.accada.epcis.soapapi.EPCISBodyExtensionType extension) {
        this.extension = extension;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis:xsd:1", "EPCISBodyType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:epcis:xsd:1", "EPCISBodyExtensionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
