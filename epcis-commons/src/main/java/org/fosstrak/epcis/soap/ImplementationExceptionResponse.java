...
public class ImplementationExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.ImplementationException implementationException;
    ...
    public ImplementationExceptionResponse(String message,
            org.accada.epcis.soap.model.ImplementationException implementationException) {
        super(message);
        this.implementationException = implementationException;
    }

    public ImplementationExceptionResponse(String message,
            org.accada.epcis.soap.model.ImplementationException implementationException, Throwable cause) {
        super(message, cause);
        this.implementationException = implementationException;
    }

    public org.accada.epcis.soap.model.ImplementationException getFaultInfo() {
