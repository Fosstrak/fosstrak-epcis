...
public class QueryTooComplexExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.QueryTooComplexException queryTooComplexException;
    ...
    public QueryTooComplexExceptionResponse(String message,
            org.accada.epcis.soap.model.QueryTooComplexException queryTooComplexException) {
        super(message);
        this.queryTooComplexException = queryTooComplexException;
    }

    public QueryTooComplexExceptionResponse(String message,
            org.accada.epcis.soap.model.QueryTooComplexException queryTooComplexException, Throwable cause) {
        super(message, cause);
        this.queryTooComplexException = queryTooComplexException;
    }

    public org.accada.epcis.soap.model.QueryTooComplexException getFaultInfo() {
