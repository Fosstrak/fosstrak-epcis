...
public class DuplicateSubscriptionExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.DuplicateSubscriptionException duplicateSubscriptionException;
    ...
    public DuplicateSubscriptionExceptionResponse(String message,
            org.accada.epcis.soap.model.DuplicateSubscriptionException duplicateSubscriptionException) {
        super(message);
        this.duplicateSubscriptionException = duplicateSubscriptionException;
    }

    public DuplicateSubscriptionExceptionResponse(String message,
            org.accada.epcis.soap.model.DuplicateSubscriptionException duplicateSubscriptionException, Throwable cause) {
        super(message, cause);
        this.duplicateSubscriptionException = duplicateSubscriptionException;
    }

    public org.accada.epcis.soap.model.DuplicateSubscriptionException getFaultInfo() {
