...
public class ValidationExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.ValidationException validationException;
    ...
    public ValidationExceptionResponse(String message,
            org.accada.epcis.soap.model.ValidationException validationException) {
        super(message);
        this.validationException = validationException;
    }

    public ValidationExceptionResponse(String message,
            org.accada.epcis.soap.model.ValidationException validationException, Throwable cause) {
        super(message, cause);
        this.validationException = validationException;
    }

    public org.accada.epcis.soap.model.ValidationException getFaultInfo() {
