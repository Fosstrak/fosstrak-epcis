...
public class QueryTooLargeExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.QueryTooLargeException queryTooLargeException;
    ...
    public QueryTooLargeExceptionResponse(String message,
            org.accada.epcis.soap.model.QueryTooLargeException queryTooLargeException) {
        super(message);
        this.queryTooLargeException = queryTooLargeException;
    }

    public QueryTooLargeExceptionResponse(String message,
            org.accada.epcis.soap.model.QueryTooLargeException queryTooLargeException, Throwable cause) {
        super(message, cause);
        this.queryTooLargeException = queryTooLargeException;
    }

    public org.accada.epcis.soap.model.QueryTooLargeException getFaultInfo() {
