...
public class NoSuchNameExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.NoSuchNameException noSuchNameException;
    ...
    public NoSuchNameExceptionResponse(String message,
            org.accada.epcis.soap.model.NoSuchNameException noSuchNameException) {
        super(message);
        this.noSuchNameException = noSuchNameException;
    }

    public NoSuchNameExceptionResponse(String message,
            org.accada.epcis.soap.model.NoSuchNameException noSuchNameException, Throwable cause) {
        super(message, cause);
        this.noSuchNameException = noSuchNameException;
    }

    public org.accada.epcis.soap.model.NoSuchNameException getFaultInfo() {
