...
public class InvalidURIExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.InvalidURIException invalidURIException;
    ...
    public InvalidURIExceptionResponse(String message,
            org.accada.epcis.soap.model.InvalidURIException invalidURIException) {
        super(message);
        this.invalidURIException = invalidURIException;
    }

    public InvalidURIExceptionResponse(String message,
            org.accada.epcis.soap.model.InvalidURIException invalidURIException, Throwable cause) {
        super(message, cause);
        this.invalidURIException = invalidURIException;
    }

    public org.accada.epcis.soap.model.InvalidURIException getFaultInfo() {
