...
public class SubscriptionControlsExceptionResponse extends Exception {
    ...
    private org.accada.epcis.soap.model.SubscriptionControlsException subscriptionControlsException;
    ...
    public SubscriptionControlsExceptionResponse(String message,
            org.accada.epcis.soap.model.SubscriptionControlsException subscriptionControlsException) {
        super(message);
        this.subscriptionControlsException = subscriptionControlsException;
    }

    public SubscriptionControlsExceptionResponse(String message,
            org.accada.epcis.soap.model.SubscriptionControlsException subscriptionControlsException, Throwable cause) {
        super(message, cause);
        this.subscriptionControlsException = subscriptionControlsException;
    }

    public org.accada.epcis.soap.model.SubscriptionControlsException getFaultInfo() {
